...
export async function buildFinalMessages(
  ...
  console.log("buildFinalMessages")
  const {
    chatSettings,
    workspaceInstructions,
    chatMessages,
...
console.log(chatSettings.prompt)
console.log(chatSettings.includeProfileContext)
console.log(chatSettings.includeWorkspaceInstructions)
console.log(assistant)
  ...
  console.log("buildFinalMessages3")
  ...
  const processedChatMessages = chatMessages.map((chatMessage, index) => {
    ...
    if (nextChatMessage === undefined) {
      console.log("nextChatMessage is undefined")
      return chatMessage
    }

    const nextChatMessageFileItems = nextChatMessage.fileItems
    console.log("nextChatMessageFileItems", nextChatMessageFileItems)

    if (nextChatMessageFileItems.length > 0) {
      console.log("nextChatMessageFileItems2")
...
function buildRetrievalText(fileItems: Tables<"file_items">[]) {
  ...
  return `You may use the following sources if needed to answer the user's question. If you don't know the answer, answer with your own knowledge"\n\n${retrievalText}`
}
